...
{
    public class PressIconButton : AnimBuilder
    {
        private Image image;
        ...
        public PressIconButton SetImage(Image image)
        {
            this.image = image;
            return this;
        }

        public PressIconButton SetScale(float scale)
        {
            this.scale = scale;
            return this;
        }

        public PressIconButton SetColor(Color color)
        {
            this.color = color;
            return this;
        }
