...
{
    public class SetBaseButton : AnimBuilder
    {
        private Image image;
        ...
        public SetBaseButton SetImage(Image image)
        {
            this.image = image;
            return this;
        }

        public SetBaseButton SetScale(float scale)
        {
            this.scale = scale;
            return this;
        }

        public SetBaseButton SetColor(Color color)
        {
            this.color = color;
            return this;
        }
